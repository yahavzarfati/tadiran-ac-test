...
class AirConditionerSferaAccessory extends BaseAccessory {
	...
	constructor(...props) {
		...
		console.error("*** Instantiating Sfera Accessory ***")
		...
		// hard coded for tadiran sfera
		this._rotationSteps = ["auto","low","mid_low","mid","mid_high","high","strong"]
	...
	_registerCharacteristics(dps) {
		...
		console.error("******* on change triggered - dps: ", JSON.stringify(state));
			...
			if ('3' in changes && characteristicCurrentTemperature.value !== changes['3']) characteristicCurrentTemperature.updateValue(changes['3']);
...
module.exports = AirConditionerSferaAccessory;