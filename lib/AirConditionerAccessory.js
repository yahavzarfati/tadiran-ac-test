...
const MODEL_FACTORS = require('./ModelFactors'); // Import constants
...
class AirConditionerAccessory extends BaseAccessory {
	...
	constructor(...props) {
		...
		this.constants = MODEL_FACTORS[this.device.context];

		console.error("*** Instantiating Accessory: ", this.device.context.model);
