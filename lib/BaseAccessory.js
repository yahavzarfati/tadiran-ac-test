...
class BaseAccessory {
	constructor(...props) {
		...
		this.constants = MODEL_FACTORS[this.device.context.model];
		console.log(`*** Instantiating Accessory: ${this.device.context.model} ***`);
		console.log("*** DEBUG: constants =", this.constants);
